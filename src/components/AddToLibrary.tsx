        ...
        <div className="addlib-body">
          ...
          {searched && !loading && results.length > 0 && (
            <div className="addlib-controls">
              <div className="seg">
                <button className={packsOnly ? "active" : ""} onClick={() => setPacksOnly(true)}>
                  <Icon icon={layers} size="xs" /> Season packs
                </button>
                <button className={!packsOnly ? "active" : ""} onClick={() => setPacksOnly(false)}>
                  All results
                </button>
              </div>
