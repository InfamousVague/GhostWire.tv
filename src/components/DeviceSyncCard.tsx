  ...
  return (
    <div className="settings-group device-sync">
      ...
      <div className="device-sync-controls">
        ...
        <label className="device-sync-mirror" title="Also delete tracks on the device that are no longer in your Library">
          <input type="checkbox" checked={mirror} onChange={(e) => setMirror(e.currentTarget.checked)} disabled={active !== null} />
